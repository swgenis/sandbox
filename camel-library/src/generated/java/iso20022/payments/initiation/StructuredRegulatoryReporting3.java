...
@XmlType(name = "StructuredRegulatoryReporting3", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.09", propOrder = {
    "tp",
    "dt",
    "ctry",
    "cd",
...
public class StructuredRegulatoryReporting3 {
    ...
    @XmlElement(name = "Inf", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.09")
