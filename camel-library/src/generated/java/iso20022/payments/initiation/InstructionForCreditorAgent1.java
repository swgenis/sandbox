...
@XmlType(name = "InstructionForCreditorAgent1", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.09", propOrder = {
    "cd",
    "instrInf"
})
public class InstructionForCreditorAgent1 {
    ...
    @XmlElement(name = "InstrInf", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.09")
