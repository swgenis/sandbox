...
@XmlType(name = "DatePeriod2", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.09", propOrder = {
    "frDt",
    "toDt"
})
public class DatePeriod2 {

    @XmlElement(name = "FrDt", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.09", required = true)
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar frDt;
    @XmlElement(name = "ToDt", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.09", required = true)
    @XmlSchemaType(name = "date")
