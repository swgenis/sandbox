...
@XmlType(name = "Contact4", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.09", propOrder = {
    "nmPrfx",
    "nm",
    "phneNb",
    "mobNb",
...
public class Contact4 {
    ...
    @XmlElement(name = "NmPrfx", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.09")
    @XmlSchemaType(name = "string")
    protected NamePrefix2Code nmPrfx;
    @XmlElement(name = "Nm", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.09")
    protected String nm;
    @XmlElement(name = "PhneNb", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.09")
    protected String phneNb;
    @XmlElement(name = "MobNb", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.09")
    protected String mobNb;
    @XmlElement(name = "FaxNb", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.09")
    protected String faxNb;
    @XmlElement(name = "EmailAdr", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.09")
    protected String emailAdr;
    @XmlElement(name = "EmailPurp", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.09")
    protected String emailPurp;
    @XmlElement(name = "JobTitl", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.09")
    protected String jobTitl;
    @XmlElement(name = "Rspnsblty", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.09")
    protected String rspnsblty;
    @XmlElement(name = "Dept", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.09")
    protected String dept;
    @XmlElement(name = "Othr", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.09")
    protected List<OtherContact1> othr;
    @XmlElement(name = "PrefrdMtd", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.09")
    @XmlSchemaType(name = "string")
