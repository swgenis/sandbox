...
@XmlType(name = "TaxPeriod2", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.09", propOrder = {
    "yr",
    "tp",
    "frToDt"
})
public class TaxPeriod2 {
    ...
    @XmlElement(name = "Yr", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.09")
    ...
    @XmlElement(name = "FrToDt", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.09")
