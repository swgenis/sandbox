 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Tp" type="{urn:iso:std:iso:20022:tech:xsd:pain.002.001.09}ReferredDocumentType4" minOccurs="0"/&gt;
 ...
 *         &lt;element name="LineDtls" type="{urn:iso:std:iso:20022:tech:xsd:pain.002.001.09}DocumentLineInformation1" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "ReferredDocumentInformation7", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.002.001.09", propOrder = {
    "tp",
    "nb",
    "rltdDt",
    "lineDtls"
...
public class ReferredDocumentInformation7 {
    ...
    @XmlElement(name = "LineDtls", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.002.001.09")
