...
@Validated
public class RetrievePaymentMechanism {
    ...
    public RetrievePaymentMechanism acHAccessServiceSessionReference(ACHSession acHAccessServiceSessionReference) {
    ...
    public RetrievePaymentMechanism acHAccessSchedule(Schedule acHAccessSchedule) {
    ...
    public RetrievePaymentMechanism correspondentServiceSessionReference(CorrespondentServiceSession correspondentServiceSessionReference) {
    ...
    public RetrievePaymentMechanism correspondentServiceAccessSchedule(Schedule correspondentServiceAccessSchedule) {
    ...
    public RetrievePaymentMechanism paymentTransactionInitiatorReference(Involvedparty paymentTransactionInitiatorReference) {
    ...
    public RetrievePaymentMechanism paymentOrderReference(Payment paymentOrderReference) {
    ...
    public RetrievePaymentMechanism payerReference(Involvedparty payerReference) {
    ...
    public RetrievePaymentMechanism payerBankReference(Involvedparty payerBankReference) {
    ...
    public RetrievePaymentMechanism payerProductInstanceReference(ProductAgreement payerProductInstanceReference) {
    ...
    public RetrievePaymentMechanism payeeReference(Involvedparty payeeReference) {
    ...
    public RetrievePaymentMechanism payeeBankReference(Involvedparty payeeBankReference) {
    ...
    public RetrievePaymentMechanism payeeProductInstanceReference(ProductAgreement payeeProductInstanceReference) {
    ...
    public RetrievePaymentMechanism amount(String amount) {
    ...
    public RetrievePaymentMechanism currency(String currency) {
    ...
    public RetrievePaymentMechanism dateType(Paymentdatetimetypevalues dateType) {
    ...
    public RetrievePaymentMechanism date(String date) {
    ...
    public RetrievePaymentMechanism washAccountReference(Account washAccountReference) {
    ...
    public RetrievePaymentMechanism intermediaryAccountReference(Account intermediaryAccountReference) {
    ...
    public RetrievePaymentMechanism paymentMechanismType(Paymentmechanismtypevalues paymentMechanismType) {
    ...
    public RetrievePaymentMechanism paymentProcessingConfiguration(PaymentProcessing paymentProcessingConfiguration) {
    ...
    public RetrievePaymentMechanism settlementInstruction(CashSettlement settlementInstruction) {
    ...
    public boolean equals(Object o) {
        ...
        RetrievePaymentMechanism retrievePaymentMechanism = (RetrievePaymentMechanism) o;
        return Objects.equals(this.acHAccessServiceSessionReference, retrievePaymentMechanism.acHAccessServiceSessionReference) &&
                Objects.equals(this.acHAccessSchedule, retrievePaymentMechanism.acHAccessSchedule) &&
                Objects.equals(this.correspondentServiceSessionReference, retrievePaymentMechanism.correspondentServiceSessionReference) &&
                Objects.equals(this.correspondentServiceAccessSchedule, retrievePaymentMechanism.correspondentServiceAccessSchedule) &&
                Objects.equals(this.paymentTransactionInitiatorReference, retrievePaymentMechanism.paymentTransactionInitiatorReference) &&
                Objects.equals(this.paymentOrderReference, retrievePaymentMechanism.paymentOrderReference) &&
                Objects.equals(this.payerReference, retrievePaymentMechanism.payerReference) &&
                Objects.equals(this.payerBankReference, retrievePaymentMechanism.payerBankReference) &&
                Objects.equals(this.payerProductInstanceReference, retrievePaymentMechanism.payerProductInstanceReference) &&
                Objects.equals(this.payeeReference, retrievePaymentMechanism.payeeReference) &&
                Objects.equals(this.payeeBankReference, retrievePaymentMechanism.payeeBankReference) &&
                Objects.equals(this.payeeProductInstanceReference, retrievePaymentMechanism.payeeProductInstanceReference) &&
                Objects.equals(this.amount, retrievePaymentMechanism.amount) &&
                Objects.equals(this.currency, retrievePaymentMechanism.currency) &&
                Objects.equals(this.dateType, retrievePaymentMechanism.dateType) &&
                Objects.equals(this.date, retrievePaymentMechanism.date) &&
                Objects.equals(this.washAccountReference, retrievePaymentMechanism.washAccountReference) &&
                Objects.equals(this.intermediaryAccountReference, retrievePaymentMechanism.intermediaryAccountReference) &&
                Objects.equals(this.paymentMechanismType, retrievePaymentMechanism.paymentMechanismType) &&
                Objects.equals(this.paymentProcessingConfiguration, retrievePaymentMechanism.paymentProcessingConfiguration) &&
                Objects.equals(this.settlementInstruction, retrievePaymentMechanism.settlementInstruction);
    }
    ...
    public String toString() {
        ...
        sb.append("class RetrievePaymentMechanism {\n");
