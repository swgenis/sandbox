...
public class InitiatePaymentExecutionProcedureResponse {
    ...
    public InitiatePaymentExecutionProcedureResponse acHAccessServiceSessionReference(ACHSession acHAccessServiceSessionReference) {
    ...
    public InitiatePaymentExecutionProcedureResponse acHAccessSchedule(Schedule acHAccessSchedule) {
    ...
    public InitiatePaymentExecutionProcedureResponse correspondentServiceSessionReference(CorrespondentServiceSession correspondentServiceSessionReference) {
    ...
    public InitiatePaymentExecutionProcedureResponse correspondentServiceAccessSchedule(Schedule correspondentServiceAccessSchedule) {
    ...
    public InitiatePaymentExecutionProcedureResponse paymentTransactionInitiatorReference(Involvedparty paymentTransactionInitiatorReference) {
    ...
    public InitiatePaymentExecutionProcedureResponse paymentOrderReference(Payment paymentOrderReference) {
    ...
    public InitiatePaymentExecutionProcedureResponse payerReference(Involvedparty payerReference) {
    ...
    public InitiatePaymentExecutionProcedureResponse payerBankReference(Involvedparty payerBankReference) {
    ...
    public InitiatePaymentExecutionProcedureResponse payerProductInstanceReference(ProductAgreement payerProductInstanceReference) {
    ...
    public InitiatePaymentExecutionProcedureResponse payeeReference(Involvedparty payeeReference) {
    ...
    public InitiatePaymentExecutionProcedureResponse payeeBankReference(Involvedparty payeeBankReference) {
    ...
    public InitiatePaymentExecutionProcedureResponse payeeProductInstanceReference(ProductAgreement payeeProductInstanceReference) {
    ...
    public InitiatePaymentExecutionProcedureResponse amount(String amount) {
    ...
    public InitiatePaymentExecutionProcedureResponse currency(String currency) {
    ...
    public InitiatePaymentExecutionProcedureResponse dateType(Paymentdatetimetypevalues dateType) {
    ...
    public InitiatePaymentExecutionProcedureResponse date(String date) {
    ...
    public InitiatePaymentExecutionProcedureResponse washAccountReference(Account washAccountReference) {
    ...
    public InitiatePaymentExecutionProcedureResponse intermediaryAccountReference(Account intermediaryAccountReference) {
    ...
    public InitiatePaymentExecutionProcedureResponse paymentMechanismType(Paymentmechanismtypevalues paymentMechanismType) {
    ...
    public InitiatePaymentExecutionProcedureResponse paymentProcessingConfiguration(PaymentProcessing paymentProcessingConfiguration) {
    ...
    public InitiatePaymentExecutionProcedureResponse settlementInstruction(CashSettlement settlementInstruction) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.acHAccessServiceSessionReference, initiatePaymentExecutionProcedureResponse.acHAccessServiceSessionReference) &&
                Objects.equals(this.acHAccessSchedule, initiatePaymentExecutionProcedureResponse.acHAccessSchedule) &&
                Objects.equals(this.correspondentServiceSessionReference, initiatePaymentExecutionProcedureResponse.correspondentServiceSessionReference) &&
                Objects.equals(this.correspondentServiceAccessSchedule, initiatePaymentExecutionProcedureResponse.correspondentServiceAccessSchedule) &&
                Objects.equals(this.paymentTransactionInitiatorReference, initiatePaymentExecutionProcedureResponse.paymentTransactionInitiatorReference) &&
                Objects.equals(this.paymentOrderReference, initiatePaymentExecutionProcedureResponse.paymentOrderReference) &&
                Objects.equals(this.payerReference, initiatePaymentExecutionProcedureResponse.payerReference) &&
                Objects.equals(this.payerBankReference, initiatePaymentExecutionProcedureResponse.payerBankReference) &&
                Objects.equals(this.payerProductInstanceReference, initiatePaymentExecutionProcedureResponse.payerProductInstanceReference) &&
                Objects.equals(this.payeeReference, initiatePaymentExecutionProcedureResponse.payeeReference) &&
                Objects.equals(this.payeeBankReference, initiatePaymentExecutionProcedureResponse.payeeBankReference) &&
                Objects.equals(this.payeeProductInstanceReference, initiatePaymentExecutionProcedureResponse.payeeProductInstanceReference) &&
                Objects.equals(this.amount, initiatePaymentExecutionProcedureResponse.amount) &&
                Objects.equals(this.currency, initiatePaymentExecutionProcedureResponse.currency) &&
                Objects.equals(this.dateType, initiatePaymentExecutionProcedureResponse.dateType) &&
                Objects.equals(this.date, initiatePaymentExecutionProcedureResponse.date) &&
                Objects.equals(this.washAccountReference, initiatePaymentExecutionProcedureResponse.washAccountReference) &&
                Objects.equals(this.intermediaryAccountReference, initiatePaymentExecutionProcedureResponse.intermediaryAccountReference) &&
                Objects.equals(this.paymentMechanismType, initiatePaymentExecutionProcedureResponse.paymentMechanismType) &&
                Objects.equals(this.paymentProcessingConfiguration, initiatePaymentExecutionProcedureResponse.paymentProcessingConfiguration) &&
                Objects.equals(this.settlementInstruction, initiatePaymentExecutionProcedureResponse.settlementInstruction);
    }
