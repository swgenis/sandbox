...
/**
 * (DDD Entity) - An identifier that allows to uniquely refer to an instance of an ACH Session. Identifier
 */
@Schema(description = "(DDD Entity) - An identifier that allows to uniquely refer to an instance of an ACH Session. Identifier ")
@Validated
