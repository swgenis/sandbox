...
/**
 * RetrievePaymentExecutionProcedureRequest
 */
@Validated
public class RetrievePaymentExecutionProcedureRequest {
    ...
    public RetrievePaymentExecutionProcedureRequest acHAccessServiceSessionReference(ACHSession acHAccessServiceSessionReference) {
    ...
    public RetrievePaymentExecutionProcedureRequest acHAccessSchedule(Schedule acHAccessSchedule) {
    ...
    public RetrievePaymentExecutionProcedureRequest correspondentServiceSessionReference(CorrespondentServiceSession correspondentServiceSessionReference) {
    ...
    public RetrievePaymentExecutionProcedureRequest correspondentServiceAccessSchedule(Schedule correspondentServiceAccessSchedule) {
    ...
    public RetrievePaymentExecutionProcedureRequest paymentTransactionInitiatorReference(Involvedparty paymentTransactionInitiatorReference) {
    ...
    public RetrievePaymentExecutionProcedureRequest paymentOrderReference(Payment paymentOrderReference) {
    ...
    public RetrievePaymentExecutionProcedureRequest payerReference(Involvedparty payerReference) {
    ...
    public RetrievePaymentExecutionProcedureRequest payerBankReference(Involvedparty payerBankReference) {
    ...
    public RetrievePaymentExecutionProcedureRequest payerProductInstanceReference(ProductAgreement payerProductInstanceReference) {
    ...
    public RetrievePaymentExecutionProcedureRequest payeeReference(Involvedparty payeeReference) {
    ...
    public RetrievePaymentExecutionProcedureRequest payeeBankReference(Involvedparty payeeBankReference) {
    ...
    public RetrievePaymentExecutionProcedureRequest payeeProductInstanceReference(ProductAgreement payeeProductInstanceReference) {
    ...
    public RetrievePaymentExecutionProcedureRequest amount(String amount) {
    ...
    public RetrievePaymentExecutionProcedureRequest currency(String currency) {
    ...
    public RetrievePaymentExecutionProcedureRequest dateType(Paymentdatetimetypevalues dateType) {
    ...
    public RetrievePaymentExecutionProcedureRequest date(String date) {
    ...
    public RetrievePaymentExecutionProcedureRequest washAccountReference(Account washAccountReference) {
    ...
    public RetrievePaymentExecutionProcedureRequest intermediaryAccountReference(Account intermediaryAccountReference) {
    ...
    public RetrievePaymentExecutionProcedureRequest paymentMechanismType(Paymentmechanismtypevalues paymentMechanismType) {
    ...
    public RetrievePaymentExecutionProcedureRequest paymentProcessingConfiguration(PaymentProcessing paymentProcessingConfiguration) {
    ...
    public RetrievePaymentExecutionProcedureRequest settlementInstruction(CashSettlement settlementInstruction) {
    ...
    public boolean equals(Object o) {
        ...
        RetrievePaymentExecutionProcedureRequest retrievePaymentExecutionProcedureRequest = (RetrievePaymentExecutionProcedureRequest) o;
        return Objects.equals(this.acHAccessServiceSessionReference, retrievePaymentExecutionProcedureRequest.acHAccessServiceSessionReference) &&
                Objects.equals(this.acHAccessSchedule, retrievePaymentExecutionProcedureRequest.acHAccessSchedule) &&
                Objects.equals(this.correspondentServiceSessionReference, retrievePaymentExecutionProcedureRequest.correspondentServiceSessionReference) &&
                Objects.equals(this.correspondentServiceAccessSchedule, retrievePaymentExecutionProcedureRequest.correspondentServiceAccessSchedule) &&
                Objects.equals(this.paymentTransactionInitiatorReference, retrievePaymentExecutionProcedureRequest.paymentTransactionInitiatorReference) &&
                Objects.equals(this.paymentOrderReference, retrievePaymentExecutionProcedureRequest.paymentOrderReference) &&
                Objects.equals(this.payerReference, retrievePaymentExecutionProcedureRequest.payerReference) &&
                Objects.equals(this.payerBankReference, retrievePaymentExecutionProcedureRequest.payerBankReference) &&
                Objects.equals(this.payerProductInstanceReference, retrievePaymentExecutionProcedureRequest.payerProductInstanceReference) &&
                Objects.equals(this.payeeReference, retrievePaymentExecutionProcedureRequest.payeeReference) &&
                Objects.equals(this.payeeBankReference, retrievePaymentExecutionProcedureRequest.payeeBankReference) &&
                Objects.equals(this.payeeProductInstanceReference, retrievePaymentExecutionProcedureRequest.payeeProductInstanceReference) &&
                Objects.equals(this.amount, retrievePaymentExecutionProcedureRequest.amount) &&
                Objects.equals(this.currency, retrievePaymentExecutionProcedureRequest.currency) &&
                Objects.equals(this.dateType, retrievePaymentExecutionProcedureRequest.dateType) &&
                Objects.equals(this.date, retrievePaymentExecutionProcedureRequest.date) &&
                Objects.equals(this.washAccountReference, retrievePaymentExecutionProcedureRequest.washAccountReference) &&
                Objects.equals(this.intermediaryAccountReference, retrievePaymentExecutionProcedureRequest.intermediaryAccountReference) &&
                Objects.equals(this.paymentMechanismType, retrievePaymentExecutionProcedureRequest.paymentMechanismType) &&
                Objects.equals(this.paymentProcessingConfiguration, retrievePaymentExecutionProcedureRequest.paymentProcessingConfiguration) &&
                Objects.equals(this.settlementInstruction, retrievePaymentExecutionProcedureRequest.settlementInstruction);
    }
    ...
    public String toString() {
        ...
        sb.append("class RetrievePaymentExecutionProcedureRequest {\n");
